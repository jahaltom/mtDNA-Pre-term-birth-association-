...
#BSUB -o logs/mtcn_%J_%I.out
#BSUB -e logs/mtcn_%J_%I.err
...
# =========================================================
# Usage
# bsub < mtcn_array_lsf.sh bam_list.txt ref.fa outdir
# or:
# bsub -J "mtcn_array[1-127]%25" < mtcn_array_lsf.sh bam_list.txt ref.fa outdir
# =========================================================
if [[ $# -ne 3 ]]; then
...
# =========================================================
TASK_ID="${LSB_JOBINDEX:?ERROR: LSB_JOBINDEX not set}"
...
echo "BAM: $bam" >&2
echo "LSF job ID: ${LSB_JOBID:-NA}" >&2
echo "LSF array index: ${LSB_JOBINDEX:-NA}" >&2
