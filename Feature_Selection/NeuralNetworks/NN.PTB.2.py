...
def evaluate_model(model, X_test, y_test, model_name):
    ...
    if y_pred_proba is not None:
        ...
        plt.legend()
        plt.show()
        plt.savefig("ROC_AUC_plot.NN.png")
        plt.clf()
...
X_train_balanced = pd.DataFrame(X_train_preprocessed, columns=preprocessor.get_feature_names_out())
...
plt.savefig("shap_summary_plot.NN.png")
plt.clf()
