...
#Read in raw counts
md = read.table(paste("Metadata.Final.tsv",sep=""),header=TRUE,sep = '\t',quote = "")
    


                              
eigenvalues = read.table(paste("PCA-MDS/out.eigenval",sep=""))
