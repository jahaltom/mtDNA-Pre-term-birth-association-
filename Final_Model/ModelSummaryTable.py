...
for p in populations:
    ...
    model_root = Path(
        p + "/mtDNA-Pre-term-birth-association-/Final_Model_Results"
    )
    ...
    for file in os.listdir(model_root):
        ...
        if ga_brm_path.exists() and ga_tmb_T_path.exists() and ga_tmb_G_path.exists():
            ...
            ga_tmb_G_final = pd.DataFrame({
                ...
                "effect_days": ga_tmbG["beta_days"],
                "ci_low_days": ga_tmbG["lo_days"],
                "ci_high_days": ga_tmbG["hi_days"],
            ...
            ga_tmb_T_final = pd.DataFrame({
                ...
                "effect_days": ga_tmbT["beta_days"],
                "ci_low_days": ga_tmbT["lo_days"],
                "ci_high_days": ga_tmbT["hi_days"],
