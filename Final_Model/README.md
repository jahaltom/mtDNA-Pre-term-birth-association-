...
Each Bayesian model automatically exports:

* Trace plots for visual assessment of chain mixing
* Posterior predictive checks
* Rhat summaries
* Bulk effective sample size
* Tail effective sample size
* Divergence counts
* Maximum treedepth diagnostics
* BFMI or sampler-energy diagnostics
* Raw NUTS sampler parameters

These outputs are generated by the automated Bayesian diagnostics function for the final GA and PTB models.
...
- Script needs to be placed in the directory before Population/mtDNA-Pre-term-birth-association-/Final_Model
- Update populations in this script accordingly.
- This will be used to find the best model via lowest AIC/BIC.
- Once a final model is selected, rerun finalModel.sh (see previous page).
```
populations = [
    "African",
    "AMANHI-Pemba",
