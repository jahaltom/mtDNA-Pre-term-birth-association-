...
- Also reports categorical variables with exactly two classes (binary). These will both be used as binary variables for Feature selection. Outputs Categorical variables for Feature selection.
