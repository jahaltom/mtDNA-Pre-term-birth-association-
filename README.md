...
- Also reports categorical variables with exactly two classes (binary) and continuous variables. These will both be used as continuous variables for Feature selection. Outputs Categorical variables for Feature selection.
